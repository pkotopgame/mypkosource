...
LW_RESULT lwInitMeshLibSystem(lwISystem** ret_sys, lwISysGraphics** ret_sys_graphics, IDirect3DX* d3d, IDirect3DDeviceX* dev, HWND hwnd)
{
    ...
    }
    {
        ...
        //ssm->CreateStreamEntitySeq(16384, 16384);
        //ssm->CreateVertexBufferStream(0, 8 * 1024 * 1024);
        //ssm->CreateVertexBufferStream(1, 8 * 1024 * 1024);
        //ssm->CreateVertexBufferStream(2, 8 * 1024 * 1024);
        //ssm->CreateVertexBufferStream(3, 8 * 1024 * 1024);
        //ssm->CreateVertexBufferStream(4, 8 * 1024 * 1024);
        //ssm->CreateVertexBufferStream(5, 8 * 1024 * 1024);
        //ssm->CreateIndexBufferStream(0, 8 * 1024 * 1024);
        //ssm->CreateIndexBufferStream(1, 8 * 1024 * 1024);
        //ssm->CreateIndexBufferStream(2, 8 * 1024 * 1024);
        //lwIDynamicStreamMgr* dsm = res_mgr->GetDynamicStreamMgr();
        //dsm->Create(2 * 512 * 1024, 2 * 1024 * 512);
        //ssm->CreateStreamEntitySeq(16384, 16384);
        ssm->CreateStreamEntitySeq(4096, 4096);
        ssm->CreateVertexBufferStream(0, 1024 * 1024 * 8);
        ssm->CreateVertexBufferStream(1, 1024 * 1024 * 8);
        ssm->CreateVertexBufferStream(2, 1024 * 1024 * 8);
        ssm->CreateVertexBufferStream(3, 1024 * 1024 * 8);
        ssm->CreateVertexBufferStream(4, 1024 * 1024 * 8);
        ssm->CreateVertexBufferStream(5, 1024 * 1024 * 8);
        ssm->CreateIndexBufferStream(0, 1024 * 1024 * 8);
        ssm->CreateIndexBufferStream(1, 1024 * 1024 * 8);
        ssm->CreateIndexBufferStream(2, 1024 * 1024 * 8);
        lwIDynamicStreamMgr* dsm = res_mgr->GetDynamicStreamMgr();
        dsm->Create(512 * 1024 * 2, 1024 * 512 * 2);
        lwSetActiveISystem(sys);
        lwSetActiveIGraphicsSystem(sys_graphics);
        // end
